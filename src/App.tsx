        ...
        <div className="bg-white rounded-2xl shadow-2xl p-8">
          ...
          <div className="space-y-6">
            ...
            <div className="bg-gray-50 p-3 rounded-lg text-xs text-gray-600 flex justify-between">
              <span>Total batch: <strong>{totalLiquidLiters} L</strong></span>
              <span>Starter: <strong>{starterPercentDisplay}%</strong></span>
              <span>Sugar density: <strong>{sugarDensityDisplay} g/L</strong></span>
            </div>
            ...
            {startDateTime && (
              <div className="bg-gradient-to-r from-amber-100 to-orange-100 p-6 rounded-xl mt-8">
                ...
                <div className="space-y-4">
                  ...
                  >
                    <p
                      className={`text-3xl font-bold ${currentStage.textColor}`}
                    >
                      {currentStage.label}
                    </p>
